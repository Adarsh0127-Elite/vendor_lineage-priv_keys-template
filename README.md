...
```
$ ./check_keys.py ~/matrixx/out/target/product/lynx
/home/ab/matrixx/out/target/product/lynx/obj/ETC/com.android.apex.cts.shim.v1_prebuilt_intermediates/com.android.apex.cts.shim.apex is signed with an unknown key!
```
